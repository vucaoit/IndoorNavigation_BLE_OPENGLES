package com.example.beaconscanner.components;
...
public class JoystickView extends View implements Runnable {
    ...
    public final static long DEFAULT_LOOP_INTERVAL = 10; // 100 ms
    // Variables
    private JoystickView.OnJoystickMoveListener onJoystickMoveListener; // Listener
    ...
    protected void initJoystickView() {
        ...
        mainCircle.setARGB(50,100,100,100);
...
//                (float) centerX, (float) centerY, horizontalLine);
    ...
    public void setOnJoystickMoveListener(JoystickView.OnJoystickMoveListener listener,
                                          long repeatInterval) {
